...
#define STRING_CONFIG_H_AUTHOR "(KraczekJ, Custom Kossel)" // Who made the changes.
...
#define Z_PROBE_OFFSET {-10, 5, 5, 0}  // X, Y, Z, E distance between hotend nozzle and deployed bed leveling probe.
...
#define DELTA_PRINTABLE_RADIUS BED_DIAMETER/2 //mm
...
#define XYZ_STEPS 100


#define DEFAULT_AXIS_STEPS_PER_UNIT   {XYZ_STEPS, XYZ_STEPS, XYZ_STEPS, 145}
